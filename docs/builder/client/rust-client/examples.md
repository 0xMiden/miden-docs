...
:::note
For a complete example on how to run the client and submit transactions to the Miden node, refer to the [Getting started documentation](./get-started/index.md).
:::
